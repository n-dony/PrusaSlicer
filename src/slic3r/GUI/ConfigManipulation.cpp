...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig* config)
{
    ...
    for (auto el : { "extra_perimeters","extra_perimeters_on_overhangs", "thin_walls", "overhangs",
                    "seam_position","staggered_inner_seams", "external_perimeters_first", //"first_internal_perimeter_extrusion_width",
                     "external_perimeter_extrusion_width",
                    "perimeter_speed", "small_perimeter_speed", "first_internal_perimeter_speed", "external_perimeter_speed", "enable_dynamic_overhang_speeds"})
