...
static const t_config_enum_values s_keys_map_TemperatureOffsetLayers {
    { "all",          int(TemperatureOffsetLayers::All) },
    { "skip_topmost", int(TemperatureOffsetLayers::SkipTopmost) },
};
...
void PrintConfigDef::init_fff_params()
{
    ...
    def->set_enum<ArcFittingType>({
        { std::make_pair("disabled",       "Disabled") },
        { std::make_pair("emit_center",    "Enabled: G2/3 I J") }
    });
    def->mode = comAdvanced;
    ...
    def->set_enum<TopOnePerimeterType>({
        { std::make_pair("none",    L("Disabled")) },
        { std::make_pair("top",     L("All top surfaces")) },
        { std::make_pair("topmost", L("Topmost surface only")) }
    });
    ...
    def->set_enum<EnsureVerticalShellThickness>({
        { std::make_pair("disabled", L("Disabled")) },
        // TRN: This is a drop-down option for 'Ensure vertical shell thickness' parameter.
        { std::make_pair("partial",  L("Partial"))  },
        { std::make_pair("enabled",  L("Enabled"))  },
    });
    def->mode = comAdvanced;
    ...
    def->set_enum<InfillPattern>({
        ...
        { std::make_pair("monotonic",          L("Monotonic")) },
        { std::make_pair("monotoniclines",     L("Monotonic Lines")) },
        { std::make_pair("alignedrectilinear", L("Aligned Rectilinear")) },
        { std::make_pair("concentric",         L("Concentric")) },
        { std::make_pair("hilbertcurve",       L("Hilbert Curve")) },
        { std::make_pair("archimedeanchords",  L("Archimedean Chords")) },
        { std::make_pair("octagramspiral",     L("Octagram Spiral")) }
    });
    ...
    def->category = L("Layers and Perimeters");
    def->tooltip = L("Print the first internal perimeter last within its group, after every other perimeter "
                   "including the external one, instead of right after the external perimeter as usual. "
                   "Sometimes called \"groove injection\": letting the external wall set before the first "
                   "internal wall bonds to it can improve the surface finish at that boundary.");
    def->mode = comExpert;
    def->set_default_value(new ConfigOptionBool(false));
    ...
    def->category = L("Layers and Perimeters");
    def->tooltip = L("Reverse the print order of internal perimeters at or beyond the depth set by "
                   "\"Reverse internal perimeters starting at\", while leaving perimeters shallower "
                   "than that depth in their normal order.");
    def->mode = comExpert;
    def->set_default_value(new ConfigOptionBool(false));
    ...
    def->category = L("Layers and Perimeters");
    def->tooltip = L("Perimeter depth, counted inward from the external perimeter (1 = first internal "
                   "perimeter, 2 = second internal perimeter, and so on), at and beyond which "
                   "\"Reverse internal perimeter order\" takes effect. 0 disables the reversal "
                   "regardless of that setting.");
    def->sidetext = L("perimeter depth");
    def->min = 0;
    def->max = 10000;
    def->mode = comExpert;
    ...
    def->set_enum<InfillPattern>({
        ...
        { std::make_pair("line",               L("Line"))},
        { std::make_pair("concentric",         L("Concentric"))},
        { std::make_pair("honeycomb",          L("Honeycomb"))},
        { std::make_pair("3dhoneycomb",        L("3D Honeycomb"))},
        { std::make_pair("gyroid",             L("Gyroid"))},
        { std::make_pair("hilbertcurve",       L("Hilbert Curve"))},
        { std::make_pair("archimedeanchords",  L("Archimedean Chords"))},
        { std::make_pair("octagramspiral",     L("Octagram Spiral"))},
        { std::make_pair("adaptivecubic",      L("Adaptive Cubic"))},
        { std::make_pair("supportcubic",       L("Support Cubic"))},
        { std::make_pair("lightning",          L("Lightning"))},
        { std::make_pair("zigzag",             L("Zig Zag"))}
    });
    ...
    def->set_enum<FuzzySkinType>({
        ...
        { std::make_pair("external",   L("Outside walls")) },
        { std::make_pair("all",        L("All walls")) }
    });
    def->mode = comSimple;
    ...
    def->set_enum<GCodeFlavor>({
        { std::make_pair("reprap",         "RepRap/Sprinter") },
        { std::make_pair("reprapfirmware", "RepRapFirmware") },
        { std::make_pair("repetier",       "Repetier") },
        { std::make_pair("teacup",         "Teacup") },
        { std::make_pair("makerware",      "MakerWare (MakerBot)") },
        { std::make_pair("marlin",         "Marlin (legacy)") },
        { std::make_pair("marlin2",        "Marlin 2") },
        { std::make_pair("klipper",        "Klipper") },
        { std::make_pair("sailfish",       "Sailfish (MakerBot)") },
        { std::make_pair("mach3",          "Mach3/LinuxCNC") },
        { std::make_pair("machinekit",     "Machinekit") },
        { std::make_pair("smoothie",       "Smoothie") },
        { std::make_pair("no-extrusion",   L("No extrusion")) }
    });
    def->mode = comExpert;
    ...
    def->set_enum<LabelObjectsStyle>({
        { std::make_pair("disabled",   L("Disabled")) },
        { std::make_pair("octoprint",  L("OctoPrint comments")) },
        { std::make_pair("firmware",   L("Firmware-specific")) }
        });
    def->mode = comAdvanced;
    ...
    def->max_literal = 1000;
    def->set_enum_values(ConfigOptionDef::GUIType::f_enum_open, {
        { std::make_pair("0",      L("0 (no open anchors)")) },
        { std::make_pair("1",      L("1 mm")) },
        { std::make_pair("2",      L("2 mm")) },
        { std::make_pair("5",      L("5 mm")) },
        { std::make_pair("10",     L("10 mm")) },
        { std::make_pair("1000",   L("1000 (unlimited)")) }
    });
    def->mode = comAdvanced;
    ...
    def->set_enum_values(ConfigOptionDef::GUIType::f_enum_open, {
        { std::make_pair("0",      L("0 (not anchored)")) },
        { std::make_pair("1",      L("1 mm")) },
        { std::make_pair("2",      L("2 mm")) },
        { std::make_pair("5",      L("5 mm")) },
        { std::make_pair("10",     L("10 mm")) },
    ...
    def->set_enum<IroningType>({
        { std::make_pair("top",        L("All top surfaces")) },
        { std::make_pair("topmost",    L("Topmost surface only")) },
        { std::make_pair("solid",      L("All solid surfaces")) }
    });
    def->mode = comAdvanced;
    ...
    def->set_enum<MachineLimitsUsage>({
        { std::make_pair("emit_to_gcode",      L("Emit to G-code")) },
        { std::make_pair("time_estimate_only", L("Use for time estimate")) },
        { std::make_pair("ignore",             L("Ignore")) }
    });
    def->mode = comAdvanced;
    ...
    def->set_enum<PrintHostType>({
        { std::make_pair("prusalink",      "PrusaLink") },
        { std::make_pair("prusaconnect",   "PrusaConnect") },
        { std::make_pair("octoprint",      "OctoPrint") },
        { std::make_pair("moonraker",      "Klipper (via Moonraker)") },
        { std::make_pair("duet",           "Duet") },
        { std::make_pair("flashair",       "FlashAir") },
        { std::make_pair("astrobox",       "AstroBox") },
        { std::make_pair("repetier",       "Repetier") },
        { std::make_pair("mks",            "MKS") }
    });
    def->mode = comAdvanced;
    def->cli = ConfigOptionDef::nocli;
...
//    def->cli = ConfigOptionDef::nocli;
    ...
    def->set_enum<ScarfSeamPlacement>({
        ...
        { std::make_pair("nowhere", L("Nowhere")) },
        // TRN: Drop-down option for 'Scarf joint placement' parameter.
        { std::make_pair("contours", L("Contours")) },
...
//    def->gui_type = ConfigOptionDef::GUIType::slider;
    ...
    def->set_enum<DraftShield>({
        { std::make_pair("disabled",   L("Disabled")) },
        { std::make_pair("limited",    L("Limited")) },
        { std::make_pair("enabled",    L("Enabled")) }
    });
    def->mode = comAdvanced;
    ...
    def->set_enum<SlicingMode>({
        { std::make_pair("regular",        L("Regular")) },
        { std::make_pair("even_odd",       L("Even-odd")) },
        { std::make_pair("close_holes",    L("Close holes")) }
    });
    def->mode = comAdvanced;
...
//    def->min = 0;
    def->set_enum_values(ConfigOptionDef::GUIType::f_enum_open, {
        { std::make_pair("0",      L("0 (soluble)")) },
        { std::make_pair("0.1",    L("0.1 (detachable)")) },
        { std::make_pair("0.2",    L("0.2 (detachable)")) }
    });
    def->mode = comAdvanced;
...
//    def->min = 0;
    ...
    def->set_enum_values(ConfigOptionDef::GUIType::i_enum_open, {
        { std::make_pair("0", L("0 (off)")) },
        { std::make_pair("1", L("1 (light)")) },
        { std::make_pair("2", L("2 (default)")) },
        { std::make_pair("3", L("3 (heavy)")) }
    });
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionInt(3));
    ...
    def->set_enum<SupportMaterialPattern>({
        { std::make_pair("rectilinear",        L("Rectilinear")) },
        { std::make_pair("rectilinear-grid",   L("Rectilinear grid")) },
        { std::make_pair("honeycomb",          L("Honeycomb")) }
    });
    def->mode = comAdvanced;
    ...
    def->set_enum<PerimeterGeneratorType>({
        { std::make_pair("classic", L("Classic")) },
        { std::make_pair("arachne", L("Arachne")) }
    });
    def->mode = comAdvanced;
...
void PrintConfigDef::init_sla_params()
{
    ...
    def->set_enum<SLADisplayOrientation>({
        { std::make_pair("landscape",  L("Landscape")) },
        { std::make_pair("portrait",   L("Portrait")) }
    });
    def->mode = comExpert;
...
//    def->set_default_value(new ConfigOptionFloat(1.0));
    ...
    def->set_enum<SLAMaterialSpeed>({
        { std::make_pair("slow",           L("Slow")) },
        { std::make_pair("fast",           L("Fast")) },
        { std::make_pair("high_viscosity", L("High viscosity")) }
    });
    def->mode = comAdvanced;
...
void PrintConfigDef::init_sla_tilt_params()
{
    ...
    def->set_enum<TowerSpeeds>({
        { std::make_pair("layer1",  "1")  },
        { std::make_pair("layer2",  "2")  },
        { std::make_pair("layer3",  "3")  },
        { std::make_pair("layer4",  "4")  },
        { std::make_pair("layer5",  "5")  },
        { std::make_pair("layer8",  "8")  },
        { std::make_pair("layer11", "11") },
        { std::make_pair("layer14", "14") },
        { std::make_pair("layer18", "18") },
        { std::make_pair("layer22", "22") },
        { std::make_pair("layer24", "24") },
    });
...
CLIMiscConfigDef::CLIMiscConfigDef()
{
    ...
    def->set_enum<ForwardCompatibilitySubstitutionRule>({
        { std::make_pair("disable",        L("Bail out on unknown configuration values")) },
        { std::make_pair("enable",         L("Enable reading unknown configuration values by verbosely substituting them with defaults.")) },
        { std::make_pair("enable_silent",  L("Enable reading unknown configuration values by silently substituting them with defaults.")) }
        });
