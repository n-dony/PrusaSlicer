...
const std::map<std::string, std::vector<Step>> invalidated_by{
    ...
    {"bridge_anchor_length", steps({propagate(posPerimeters)})},
    ...
    {"bridge_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"enable_temperature_offsets", steps({propagate(psGCodeExport)})},
    ...
    {"external_perimeter_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"first_internal_perimeter_acceleration", steps({propagate(psGCodeExport)})},
    {"first_internal_perimeter_every_layers", steps({propagate(posPrepareInfill)})},
    {"first_internal_perimeter_speed", steps({propagate(psGCodeExport)})},
    {"first_internal_perimeter_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"gap_fill_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"high_def_print", steps({propagate(posPerimeters)})},
    ...
    {"infill_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"ironing_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"overhang_perimeter_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"perimeter_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"reverse_internal_perimeters", steps({propagate(posPerimeters)})},
    {"reverse_internal_perimeters_at", steps({propagate(posPerimeters)})},
    ...
    {"second_internal_perimeter_acceleration", steps({propagate(psGCodeExport)})},
    {"second_internal_perimeter_every_layers", steps({propagate(posPrepareInfill)})},
    {"second_internal_perimeter_speed", steps({propagate(psGCodeExport)})},
    {"second_internal_perimeter_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"solid_infill_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"swap_first_int_w_ext_perimeter", steps({propagate(posPerimeters)})},
    ...
    {"support_material_temperature_offset", steps({propagate(psGCodeExport)})},
    ...
    {"temperature_offset_layers", steps({propagate(psGCodeExport)})},
    ...
    {"two_pass_bridge", steps({propagate(posPerimeters)})},
    ...
    {"top_solid_infill_temperature_offset", steps({propagate(psGCodeExport)})},
