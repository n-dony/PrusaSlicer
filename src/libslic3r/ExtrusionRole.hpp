...
struct ExtrusionRole : public ExtrusionRoleModifiers
{
    ...
    // First and second internal perimeter (counted from the external perimeter inward), so that
    // per-role speed / temperature / width can be set independently of the generic Perimeter role.
