...
static PerimeterExtrusions extract_ordered_perimeter_extrusions_old(const PerimeterExtrusions &sorted_perimeter_extrusions, const bool external_perimeters_first) {
