...
static std::vector<std::string> s_Preset_print_options {
    ...
    "external_perimeter_combine", "external_perimeter_every_layers",
    "first_internal_perimeter_combine", "first_internal_perimeter_every_layers",
    "second_internal_perimeter_combine", "second_internal_perimeter_every_layers",
    "solid_infill_below_area", "only_retract_when_crossing_perimeters", "infill_first",
    "ironing", "ironing_type", "ironing_flowrate", "ironing_speed", "ironing_spacing",
    "max_print_speed", "max_volumetric_speed", "avoid_crossing_perimeters_max_detour",
    "fuzzy_skin", "fuzzy_skin_thickness", "fuzzy_skin_point_dist",
    "max_volumetric_extrusion_rate_slope_positive", "max_volumetric_extrusion_rate_slope_negative",
    "perimeter_speed", "small_perimeter_speed", "first_internal_perimeter_speed", "second_internal_perimeter_speed", "external_perimeter_speed", "infill_speed", "solid_infill_speed",
    "enable_dynamic_overhang_speeds", "overhang_speed_0", "overhang_speed_1", "overhang_speed_2", "overhang_speed_3",
    "top_solid_infill_speed", "support_material_speed", "support_material_xy_spacing", "support_material_interface_speed",
    "bridge_speed", "bridge_anchor_length", "over_bridge_speed", "gap_fill_speed", "gap_fill_enabled", "travel_speed", "travel_speed_z", "first_layer_speed", "first_layer_infill_speed", "first_layer_speed_over_raft", "perimeter_acceleration", "infill_acceleration",
    "external_perimeter_acceleration", "first_internal_perimeter_acceleration", "second_internal_perimeter_acceleration", "top_solid_infill_acceleration", "solid_infill_acceleration", "travel_acceleration", "wipe_tower_acceleration",
    ...
    "dont_support_bridges", "thick_bridges", "two_pass_bridge", "bridge_pass_count", "notes", "custom_parameters_print", "complete_objects",
    ...
    "enable_temperature_offsets", "temperature_offset_layers", "temperature_change_threshold",
    "temperature_wait_for_region_change",
    "external_perimeter_temperature_offset", "first_internal_perimeter_temperature_offset",
    "second_internal_perimeter_temperature_offset", "perimeter_temperature_offset",
    "infill_temperature_offset", "solid_infill_temperature_offset", "top_solid_infill_temperature_offset",
    "support_material_temperature_offset", "support_material_interface_temperature_offset",
    "bridge_temperature_offset", "overhang_perimeter_temperature_offset", "gap_fill_temperature_offset",
