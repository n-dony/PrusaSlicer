...
static std::vector<std::string> s_Preset_print_options {
    ...
    "enable_injection_molding_order","enable_injection_molding_temp_boost","injection_molding_temp_boost","reverse_internal_perimeters","reverse_internal_perimeters_at","external_perimeters_first",   "fill_density", "fill_pattern", "top_fill_pattern", "bottom_fill_pattern",
    ...
    "first_internal_perimeter_acceleration", "second_internal_perimeter_acceleration", "external_perimeter_acceleration", "top_solid_infill_acceleration", "solid_infill_acceleration", "travel_acceleration", "wipe_tower_acceleration",
