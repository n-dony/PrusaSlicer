...
static std::vector<std::string> s_Preset_print_options {
    ...
    "perimeter_speed", "small_perimeter_speed","first_internal_perimeter_speed", "external_perimeter_speed", "infill_speed", "solid_infill_speed",
    ...
    "first_internal_perimeter_acceleration", "external_perimeter_acceleration", "top_solid_infill_acceleration", "solid_infill_acceleration", "travel_acceleration", "wipe_tower_acceleration",
