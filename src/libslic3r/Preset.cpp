...
static std::vector<std::string> s_Preset_print_options {
    ...
    "high_def_print", "swap_first_int_w_ext_perimeter", "reverse_internal_perimeters", "reverse_internal_perimeters_at",
    ...
    "dont_support_bridges", "thick_bridges", "two_pass_bridge_scope", "notes", "custom_parameters_print", "complete_objects",
...
static std::vector<std::string> s_Preset_filament_options {
    ...
    "cooling_combine_logic", "cooling_perimeter_transition_distance", "min_fan_speed",
